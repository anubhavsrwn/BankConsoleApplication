...
namespace BankConsoleApplication
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("4. Bank Operations");
            ...
            switch (choice)
            {
                ...
                case 3:
                    ...
                    {
                        Console.Clear();
                        Console.WriteLine("Succcesfully logged in as " + BankList[choiceBank].Bankstaff.BankStaffName);
                        StaffLoginMenu:
                ...
                case 4:
                    ...
                    choiceBank = Convert.ToInt32(Console.ReadLine());
                    choiceBank--;
